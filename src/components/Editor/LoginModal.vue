        ...
        <form @submit.prevent="handleLogin" class="login-form">
          ...
          <div class="form-group">
            <div class="label-row">
              ...
              <button type="button" class="forgot-password-btn" @click="forgotPassword" :disabled="isLoading || isGoogleLoading">
                忘記密碼？
              </button>
            </div>
            <div class="input-wrapper">
          ...
          <button type="submit" class="submit-btn" :disabled="isLoading || isGoogleLoading">
            <svg v-if="isLoading" class="loading-icon" viewBox="0 0 20 20" fill="currentColor">
          ...
          <button
            ...
            :disabled="isLoading || isGoogleLoading"
          >
            <svg v-if="isGoogleLoading" class="loading-icon" viewBox="0 0 20 20" fill="currentColor">
              <path d="M10 3a1 1 0 011 1v4a1 1 0 11-2 0V4a1 1 0 011-1zm0 10a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1zm7-7a1 1 0 011 1 1 1 0 11-2 0 1 1 0 011-1zM3 10a1 1 0 011-1 1 1 0 110 2 1 1 0 01-1-1z" />
            </svg>
          ...
          <div class="register-link">
            ...
            <button type="button" class="register-btn" @click="goToRegister" :disabled="isLoading || isGoogleLoading">
              立即註冊
            </button>
          </div>
        </form>
