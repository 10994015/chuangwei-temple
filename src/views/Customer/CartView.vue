...
const cartItems=ref([
  {cartId:1, templeId:'longshan',templeName:'萬華龍山寺',type:'product', name:'平安符',       image:'https://picsum.photos/seed/c1/80/80', specs:[{value:'基本版',label:'基本版'},{value:'加持版',label:'加持版'}],                     spec:'基本版', price:200, qty:2,checked:true,specialShipping:null,  targets:[]},
  {cartId:2, templeId:'longshan',templeName:'萬華龍山寺',type:'product', name:'招財錦囊',     image:'https://picsum.photos/seed/c2/80/80', specs:[{value:'基本版',label:'基本版'},{value:'精裝版',label:'精裝版'}],                     spec:'基本版', price:300, qty:1,checked:true,specialShipping:null,  targets:[]},
  {cartId:3, templeId:'longshan',templeName:'萬華龍山寺',type:'product', name:'文昌筆',       image:'https://picsum.photos/seed/c3/80/80', specs:[{value:'標準款',label:'標準款'}],                                              spec:'標準款', price:180, qty:1,checked:true,specialShipping:150,   targets:[]},
